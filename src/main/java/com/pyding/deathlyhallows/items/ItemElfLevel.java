...
public class ItemElfLevel extends Item {
	...
	public void addInformation(ItemStack stack, EntityPlayer p, List list, boolean devMode) {
		if(p != null) {
			list.add(StatCollector.translateToLocalFormatted("dh.desc.elfLevelItem", ElfUtils.getElfLevel(p)));
		}
	}

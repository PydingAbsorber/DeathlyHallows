...
public class ElderRiteRegistry {
    ...
    public Ritual getRitual(int ritualID) {
        ...
        return (Ritual) this.rituals.get(ritualID - 1);
    }

    public void removeRitual(int ritualID) {
        this.rituals.removeIf(r -> ((Ritual) r).ritualID == ritualID);
    }
    ...
    public static class Ritual {
        ...
        public String getDescription() {
            ...
            if (!familiar.equals("")) {
                sb.append(Const.BOOK_NEWLINE);
                sb.append(Witchery.resource("witchery.rite.requirefamiliar")).append(' ').append(familiar).append(Const.BOOK_NEWLINE);
            }
            if (covenRequired != 0) {
                sb.append(Const.BOOK_NEWLINE);

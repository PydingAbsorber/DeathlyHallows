...
public class RenderAbsoluteDeath extends RenderLiving {
	...
	public void doRenderDeath(EntityAbsoluteDeath entity, double par2, double par4, double par6, float par8, float par9) {
	...
	public void doRender(EntityLiving entity, double par2, double par4, double par6, float par8, float par9) {
		this.doRenderDeath((EntityAbsoluteDeath)entity, par2, par4, par6, par8, par9);
	}

	protected ResourceLocation getEntityTexture(Entity par1Entity) {
		return this.func_110832_a((EntityAbsoluteDeath)par1Entity);
	}

	protected ResourceLocation func_110832_a(EntityAbsoluteDeath par1Entity) {
		return TEXTURE_URL;
	}

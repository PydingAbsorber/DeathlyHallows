...
import static com.pyding.deathlyhallows.DeathHallowsMod.inferioisMutandis;
...
public class ThaumcraftDH {
	...
	public static void aspects() {
		ThaumcraftApi.registerObjectTag(new ItemStack(DeathHallowsMod.elderWand), (new AspectList()).add(Aspect.MAGIC, 13)
																									.add(Aspect.DEATH, 666)
																									.add(Aspect.DARKNESS, 4)
																									.add(Aspect.WEAPON, 17));
		ThaumcraftApi.registerObjectTag(new ItemStack(DeathHallowsMod.invisibilityMantle), (new AspectList()).add(Aspect.MAGIC, 13)
																											 .add(Aspect.DEATH, 666)
																											 .add(Aspect.DARKNESS, 4)
																											 .add(Aspect.ARMOR, 17));
		ThaumcraftApi.registerObjectTag(new ItemStack(DeathHallowsMod.resurrectionStone), (new AspectList()).add(Aspect.MAGIC, 13)
																											.add(Aspect.DEATH, 666)
																											.add(Aspect.DARKNESS, 4)
																											.add(Aspect.LIFE, 17));
		ThaumcraftApi.registerObjectTag(new ItemStack(DeathHallowsMod.bertieBots), (new AspectList()).add(Aspect.HUNGER, 16)
																									 .add(Aspect.POISON, 8)
																									 .add(Aspect.HEAL, 8));
		ThaumcraftApi.registerObjectTag(new ItemStack(DeathHallowsMod.gastronomicTemptation), (new AspectList()).add(Aspect.SOUL, 8)
																												.add(Aspect.DEATH, 8)
																												.add(Aspect.UNDEAD, 8)
																												.add(Aspect.HUNGER, 4));
		ThaumcraftApi.registerObjectTag(new ItemStack(DeathHallowsMod.resurrectionStone), (new AspectList()).add(Aspect.FLESH, 1)
																											.add(Aspect.WATER, 8)
																											.add(Aspect.TREE, 16));
		ThaumcraftApi.registerObjectTag(new ItemStack(hobgoblinSoul), (new AspectList()).add(Aspect.SOUL, 16)
																						.add(Aspect.BEAST, 5));
		ThaumcraftApi.registerObjectTag(new ItemStack(DeathHallowsMod.hobgoblinChains), (new AspectList()).add(Aspect.SOUL, 16)
																										  .add(Aspect.TRAP, 64)
																										  .add(Aspect.MINE, 64));
		ThaumcraftApi.registerObjectTag(new ItemStack(DeathHallowsMod.nimbus), (new AspectList()).add(Aspect.FLIGHT, 32)
																								 .add(Aspect.TREE, 7)

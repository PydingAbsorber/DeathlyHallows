...
public class StructurePurify extends StructureBase {
	...
	protected void fillStructure() {
		...
		add(Witchery.Blocks.SNOW_STAIRS, 4, pos(-3,-2,-2), pos(-3,-2,-1), pos(-3,-2,0), pos(-3,-2,1), pos(-3,-2,2));
		add(Witchery.Blocks.SNOW_STAIRS, 6, pos(-2,-2,-3), pos(-1,-2,-3), pos(0,-2,-3), pos(1,-2,-3), pos(2,-2,-3));
		add(Witchery.Blocks.SNOW_STAIRS, 7, pos(-2,-2,3), pos(-1,-2,3), pos(0,-2,3), pos(1,-2,3), pos(2,-2,3));
		add(Witchery.Blocks.SNOW_STAIRS, 5, pos(3,-2,-2), pos(3,-2,-1), pos(3,-2,0), pos(3,-2,1), pos(3,-2,2));
		add(Witchery.Blocks.FETISH_WITCHS_LADDER, 3, pos(0,0,-3), pos(0,1,-3));
		add(Witchery.Blocks.FETISH_WITCHS_LADDER, 5, pos(-3,1,0));
		add(Witchery.Blocks.FETISH_WITCHS_LADDER, 2, pos(0,1,3));
		add(Witchery.Blocks.FETISH_WITCHS_LADDER, 4, pos(3,1,0));
		add(Witchery.Blocks.FETISH_SCARECROW, 4, pos(3,0,0));
		add(Witchery.Blocks.FETISH_TREANT_IDOL, 5, pos(-3,0,0));
		add(Witchery.Blocks.STATUE_OF_WORSHIP, 2, pos(0,0,3));
	}

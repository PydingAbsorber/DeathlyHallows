...
public class StructureIceCastle extends StructureBase {
	...
	protected void fillStructure() {
		...
		add(Witchery.Blocks.PERPETUAL_ICE_STAIRS, 0, STAIRS_ROTATOR, pos(-2, 3, 0), pos(-3, 4, -2), pos(-3, 4, 2), pos(1, 4, -2), pos(1, 4, 2));
		add(Witchery.Blocks.PERPETUAL_ICE_STAIRS, 1, STAIRS_ROTATOR, pos(2, 3, 0), pos(-1, 4, -2), pos(-1, 4, 2), pos(3, 4, -2), pos(3, 4, 2));
		add(Witchery.Blocks.PERPETUAL_ICE_STAIRS, 2, STAIRS_ROTATOR, pos(-1, 2, -3), pos(1, 2, -3), pos(-2, 4, -3), pos(-2, 4, 1), pos(2, 4, -3), pos(2, 4, 1));
		add(Witchery.Blocks.PERPETUAL_ICE_STAIRS, 3, STAIRS_ROTATOR, pos(0, 3, 2), pos(-2, 4, -1), pos(-2, 4, 3), pos(2, 4, -1), pos(2, 4, 3));
		add(Witchery.Blocks.PERPETUAL_ICE_STAIRS, 4, STAIRS_ROTATOR, pos(1, 1, -3));
		add(Witchery.Blocks.PERPETUAL_ICE_STAIRS, 5, STAIRS_ROTATOR, pos(-1, 1, -3));
	}

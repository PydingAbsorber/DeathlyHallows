...
public class StructureCurse extends StructureBase {
	...
	protected void fillStructure() {
		...
		add(Blocks.skull, 1, pos(-3, -3, -1), pos(-3, -3, 0), pos(-3, -3, 1), pos(-3, -3, 2), pos(-3, -3, 3), pos(-1, -3, -3), pos(0, -3, -3), pos(0, -3, 3), pos(1, -3, -3), pos(2, -3, -3), pos(3, -3, -3), pos(3, -3, 1), pos(3, -3, 2), pos(3, -3, 3), pos(-2, -2, -2), pos(-2, -2, -1), pos(-2, -2, 0), pos(-2, -2, 2), pos(-1, -2, -2), pos(-1, -2, 2), pos(0, -2, 2), pos(1, -2, 2), pos(2, -2, 0), pos(2, -2, 1), pos(-1, -1, -1), pos(-1, -1, 0), pos(-1, -1, 1), pos(0, -1, -1), pos(1, -1, 0), pos(1, -1, 1));
		...
		add(Witchery.Blocks.ALLURING_SKULL, 1, pos(-3, -3, -2), pos(1, -3, 3), pos(3, -3, -2), pos(-2, -2, 1), pos(2, -2, -2), pos(0, -1, 1));
	}

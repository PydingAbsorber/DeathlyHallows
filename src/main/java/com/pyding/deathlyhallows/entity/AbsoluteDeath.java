...
/*            if(o instanceof EntityThrowable)
            ...
            if(o instanceof EntitySpellEffect) {
                ...
                ChatUtil.sendTranslated(EnumChatFormatting.GREEN, worldObj.getClosestPlayerToEntity(this,64), "dh.chat.nomagic", new Object[0]);
            }
        }
    ...
    public void attac(){
        if(this.getAITarget() != null){
            ...
            if(!player.capabilities.isCreativeMode){
                ...
                ChatUtil.sendTranslated(EnumChatFormatting.RED, player, "dh.chat.creative", new Object[0]);
                this.noClip = true;
                this.teleportRandomly();
                rage = 0;
            }
    ...
    public void dropDeathlyHallows(){
        ...
        if(mvp != null){
            ChatUtil.sendTranslated(EnumChatFormatting.GREEN, mvp, "dh.chat.choice", new Object[0]);
